...
>(({ defaultOpen = true, open: openProp, onOpenChange, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    ...
    [setInternalOpen, onOpenChange, open]
  )
  ...
  const contextValue = React.useMemo<SidebarContext>(
    () => ({
      ...
      isMobile,
      openMobile,
      setOpenMobile: toggleMobile,
      toggleSidebar,
    }),
    [state, open, setOpen, isMobile, openMobile, toggleMobile, toggleSidebar]
  )
...
>(({ className, onClick, ...props }, ref) => {
  const { toggleSidebar, toggleMobile, isMobile, setOpenMobile } = useSidebar()
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[collapsible=icon]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:rounded-lg",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:invisible",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground data-[state=open]:opacity-100 peer-data-[state=open]/menu-button:text-sidebar-accent-foreground opacity-0 transition-opacity",
        className
      )}
      {...props}
    />
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-1 justify-center">
        <div className="h-2 w-16 rounded bg-sidebar-primary/10" />
      </div>
    </div>
  )
})
